...
export const Introduction: React.FC<{ isMobile: boolean; isShown: boolean }> =
  ({ isMobile, isShown }) => {
    return (
      <div id="introduction" className="introduction_container">
        ...
        <div
          className={`introduction_element_container${
            isMobile ? "_mobile" : ""
          }`}
        >
        ...
        <div style={{ marginTop: "60px", padding: "0 5%" }}>
          <span className="mont_24 green">
            現在，跟我們一起 RUN FOR GREEN！
          </span>
        </div>
